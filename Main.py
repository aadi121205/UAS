...
for i, output_image in enumerate(sorted_images):
    ...
    output_images_names.append(filename)
cv2.waitKey(0)
print("output_images_names:",output_images_names,"house_counts:",house_counts,"house_priorities:",house_priorities)
print("rescue_ratios:",rescue_ratios,"image_names:",image_names,"sorted_image_names:",sorted_image_names)
cv2.destroyAllWindows()
